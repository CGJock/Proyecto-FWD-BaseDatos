...
(1, 'Hotel Plaza', 'Ciudad A', 100, 5),
(2, 'Hotel Central', 'Ciudad B', 150, 5),
(3, 'Hotel Riviera', 'Ciudad C', 75, 5),
(4, 'Hotel Boutique', 'Ciudad D', 50, 5),
(5, 'Hotel Del Mar', 'Ciudad E', 120, 5),
(6, 'Hotel Ejecutivo', 'Ciudad F', 200, 5),
(7, 'Hotel Lux', 'Ciudad G', 90, 5),
(8, 'Hotel Nacional', 'Ciudad H', 60,5),
(9, 'Hotel Vista', 'Ciudad I', 80,5),
(10, 'Hotel Continental', 'Ciudad J', 110,5);
...
INSERT INTO Reservations (reservation_id, user_id, reservation_state_id, reservation_date, check_in_date, check_out_date, number_visitors, total_price) VALUES
(1, 1, 1, '2024-08-25', '2024-09-01', '2024-09-05', 2, 500),
(2, 2, 1,'2024-09-01', '2024-09-10', '2024-09-12', 1, 200),
(3, 3, 1,'2024-09-15', '2024-10-01', '2024-10-10', 4, 1200),
(4, 4, 1,'2024-10-20', '2024-11-15', '2024-11-20', 3, 700),
(5, 5, 1,'2024-11-15', '2024-12-01', '2024-12-07', 2, 600),
(6, 6, 2,'2024-11-30', '2024-12-20', '2024-12-25', 2, 550),
(7, 7, 2,'2024-11-20', '2024-12-05', '2024-12-10', 1, 300),
(8, 8, 2,'2024-12-01', '2024-12-10', '2024-12-15', 2, 400),
(9, 9, 1,'2024-12-01', '2024-12-15', '2024-12-20', 4, 1000),
(10, 10, 1,'2024-12-15', '2024-12-25', '2024-12-30', 2, 450);
